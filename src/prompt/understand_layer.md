...
- Do NOT emit literal escaped newlines as plain text (e.g. `\\n`) when you mean a line break; use real line breaks in content.
...
- Hard prohibition (must follow):
  ...
  - NO exam/test questions
  - NO review questions
  - NO reflective/counter-question prompts to user (e.g. “你可以思考一下…”, “你觉得…?”)
  - NO interactive Q&A that asks user to answer first
  - NO homework/checklist that evaluates learner performance
- The output must be pure explanation and demonstration content only.
...
- Ensure there is zero quiz/test/review/practice content.
- Ensure there is zero rhetorical question asking the learner to think/answer.
- Ensure all sections are direct explanations, analysis, and examples only.
